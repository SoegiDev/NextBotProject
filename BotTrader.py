...
from Function.Trading import Trading

if __name__ == '__main__':
    # Set parser
    parser = argparse.ArgumentParser()
    parser.add_argument('--api_key', type=str, help='Api Key User', required=True)
    parser.add_argument('--secret_key', type=str, help='Secret Key User', required=True)
    ...
    parser.add_argument('--stop_loss', type=float, help='Target Stop-Loss %% (If the price drops by 6%%, '
                                                        'sell market_price.)', default=0)
